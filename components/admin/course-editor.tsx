    ...
    <div>
      ...
      <div className="rounded-2xl p-6 mb-6 grid gap-4" style={{ background: "rgba(15,26,61,0.4)", border: "1px solid rgba(201,169,122,0.1)" }}>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            <label className={labelClass}>Preço (R$) <span style={{ color: "rgba(255,255,255,0.25)", fontFamily: "'Poppins',sans-serif", fontSize: 10, letterSpacing: 1, textTransform: "none", fontWeight: 400 }}>(vazio = matrícula manual)</span></label>
            <input
              type="number"
              min="0"
              step="0.01"
          ...
          <div>
            ...
            <select
              ...
              onChange={e => setCourse(c => ({ ...c, paymentType: e.target.value as "ONE_TIME" | "MONTHLY" }))}
              className="w-full bg-[rgba(255,255,255,0.04)] border border-[rgba(201,169,122,0.18)] rounded-xl px-4 py-3 text-sm text-white outline-none"
            >
